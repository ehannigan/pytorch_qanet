...
class EncoderBlock(nn.Module):
    def __init__(self, num_conv_blocks, num_heads, in_channels, out_channels, kernel_size, input_shape, depthwise, norm, layer_dropout, general_dropout, total_layers=0):
        ...
        self.forward_block = ForwardBlock(input_shape=input_shape, out_channels=out_channels, norm=norm)
